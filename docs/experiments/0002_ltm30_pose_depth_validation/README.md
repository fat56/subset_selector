# LTM30 Pose/Depth Validation Set

## Metadata

- Experiment ID: `0002_ltm30_pose_depth_validation`
- Status: prepared
- Created: 2026-06-07
- Source root: `data/raw/ltm_datasets -> /home/m/dataset/ltm_datasets`
- Manifest: `docs/experiments/0002_ltm30_pose_depth_validation/manifest.json`
- Preparation script: `scripts/prepare_ltm30_validation.py`
- Validation script: `scripts/run_ltm30_pose_depth_validation.py`
- Results: `docs/experiments/0002_ltm30_pose_depth_validation/results.md`
