...
| `0003_stage2_fixed_k_selector_training` | stage2 | design-draft | Can a fixed-K learned selector beat non-learned baselines after Stage 1 passes? | not created yet | [review](0003_stage2_fixed_k_selector_training/review.md) |
