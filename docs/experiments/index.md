...
| `0007_stage2_swap_gain_scaleup` | stage2 | completed, not promoted | Does scaling direct swap-gain labels to about 1000 scenes make the image-only student reliably beat uniform20? | [config](../../configs/experiments/0007_stage2_swap_gain_scaleup.yaml) | [review](0007_stage2_swap_gain_scaleup/review.md) |
